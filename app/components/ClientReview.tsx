...
const ClientReview = ({ name, role, image }: Props) => {
  return (
    <div className="flex flex-col text-center justify-center">
      ...
      <p className="text-white text-[16px] opacity-50 w-[90%] md:w-[50%] mx-auto">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus quidem
        neque itaque architecto odit, quas ut et excepturi, deleniti accusamus
        velit sint perspiciatis voluptas cum, nostrum maxime aut quis ipsum?
      </p>
    </div>
  );
};
